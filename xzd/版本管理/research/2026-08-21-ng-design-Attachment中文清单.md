...
| 后端模板（simple-v1）                    | 出现次数 | 源码位置                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------- | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 办理意见中包含敏感字:{{words}}{{suffix}},请修改后重新提交! |    1 | `util.ts:92`                                                                                                                                                                                                                                                                                                                                 |
| 不支持上传：{{formats}} 格式                |    1 | `upload/validateAttachOptions.ts:39`                                                                                                                                                                                                                                                                                                         |
...
| 共{{count}}文件                       |    1 | `attachment-upload.tsx:351`                                                                                                                                                                                                                                                                                                                  |
| 合计                                |    1 | `upload/upload.tsx:621`                                                                                                                                                                                                                                                                                                                      |
| 获取位置失败                            |    1 | `upload/upload.tsx:162`                                                                                                                                                                                                                                                                                                                      |
| 仅支持上传：{{formats}} 格式                |    1 | `upload/validateAttachOptions.ts:29`                                                                                                                                                                                                                                                                                                         |
| 离线数据{{index}}                      |    1 | `AttachOffline/OfflineListHelp.tsx:48`                                                                                                                                                                                                                                                                                                       |
...
| 文件大小不能超过 {{maxSize}}MB!             |    1 | `upload/validateAttachOptions.ts:50`                                                                                                                                                                                                                                                                                                         |
| 文件大小已超过 {{warnSize}}MB, 是否继续上传!     |    1 | `upload/validateAttachOptions.ts:56`                                                                                                                                                                                                                                                                                                         |
...
| 已上传{{count}}文件                     |    1 | `attachment-upload.tsx:350`                                                                                                                                                                                                                                                                                                                  |
...
| 最大上传数 {{maxCount}}                  |    5 | `attachment-upload.tsx:291`<br>`attachment-upload.tsx:312`<br>`AttachOffline/upload.tsx:208`<br>`upload/upload.tsx:519`<br>`upload/upload.tsx:545`                                                                                                                                                                                           |

...
| --- | --- | --- | --- | --- |
| `a19ead1d8c7ee6aa275e73a339e9b9ff46b3bc06` | `ljx-6.5.2` | 2026-08-24 | 新增 Attachment 语言清单、具名占位符、中文回退、弹窗按需加载与页面级缓存，并接入附件组件 | `tsx tests/attachment-i18n.test.ts` 通过；`npm run build --workspace=@newgrand/udp-ui` 通过 |
...
| `sync_branch` | 不适用 | - |
| `ljx-7.0` | 不适用 | - |
| `ljx-6.5.2` | 验证中 | `a19ead1d8c7ee6aa275e73a339e9b9ff46b3bc06` |
| `6.5.2` | 待同步 | - |
